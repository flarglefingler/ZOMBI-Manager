...
def mat_key_to_mta_stem_map(mat_paths: Iterable[str], mta_paths: Iterable[str]) -> dict[int, str]:
    ...
    manifests use archive table keys. In some world archives, the first
    appearance order of unique MAT keys matches the MTA file order. So in other words this is complete horse shit
    """
